...
export const NavBar = () => {
  ...
  // Change slight background when scrolled
  useEffect(() => {
  ...
  return (
    <nav
      className={cn(
        // Transparent always, slightly visible when scrolling
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between py-4">
        ...
        >
          <span className="relative z-10">
            <span className="text-glow text-[hsl(var(--primary))]">Bishnu</span> Portfolio
          </span>
        </a>
